...
{ name: "BXB.AX", description: "Brambles", exchange: "ASX", type: "stock" },

{ name: "LPH.BK", description: "Ladproa General Hospital", exchange: "BKK", type: "stock" },
{ name: "PS.BK", description: "Prueksa", exchange: "BKK", type: "stock" }
];
